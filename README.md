...
Landing Page para treinar habilidades do Html, CSS e Sass.

## 🧑🏻‍💻 Tecnologias 

Desenvolvido com HTML, CSS e Sass.
<div>
...
Inicialmente utilizado HTML e suas tags semânticas para montagem do corpo da página. No CSS, utilizado recursos para estilização e efeitos animados para garantir uma experiência ao usuário mais eficaz. Além de criar a aplicação de maneira responsiva, utilizando o processo de Mobile First. E por fim, utilizado a extensão Sass para obter um código mais limpo e recursos especiais como variáveis, misin e minify.
  
 Interface:


<p dir="auto">Link para acessar o projeto: <a href="https://alecamargo77.github.io/Landing-Page-Sass/"> Landing Page </a></p>

![Landing Page](https://user-images.githubusercontent.com/105398640/183304842-8b3694ff-e67c-4207-a23e-aeb2bb3a034c.gif)
